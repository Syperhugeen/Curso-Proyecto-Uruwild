 <section  style="background-color:#30302f;">
          ...
          <div class="col-lg-4 col-md-4 text-center">
            <p class="color-text-gris"> <i class="fas fa-phone"></i>2601 1234</p>
            <p class="color-text-gris"> <i class="fas fa-mobile-alt"></i> 099 123 456</p>
            <p class="color-text-gris"><i class="far fa-envelope"></i> contacto@uruwild.com</p>
          </div> 
          <div class="col-lg-4 col-md-4 text-center">
              <p class="text-muted mb-0 color-text-gris">URUWILD 2018</p>
